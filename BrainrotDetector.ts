...
export class BrainrotDetector {
  ...
  async start(): Promise<void> {
    ...
    console.log("🎥 Brainrot Detector v2 started!");
  }
  ...
  private drawActiveOverlay(): void {
    const { count, isCurrentlyAlternating, bothHandsVisible, leftVelocity, rightVelocity, calibration } = this.state;
    ...
    // Velocity indicators
    this.drawVelocityBar(150, 55, leftVelocity, "#FF6B6B");
    this.drawVelocityBar(165, 55, rightVelocity, "#4ECDC4");
